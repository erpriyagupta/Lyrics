...
class Track {
  ...
  bool get explicitStatus {
    if (this.explicit == null) return false;
    if (this.explicit == 0) return false;
    if (this.explicit == 1) return true;
    return false;
  }
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    albumName = json['album_name'].split(" ")[0];
